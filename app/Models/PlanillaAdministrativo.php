...
class PlanillaAdministrativo extends Model
{
     use HasFactory;
     ...
     * @var string
     */
    protected $table = 'planillaAdministrativo';
     ...
     * @var string
     */
    protected $primaryKey = 'plaadm_id';
     ...
     */
    protected $casts = [
        'plaadm_iImpreso' => 'boolean',
        'plaadm_dtFechaImpresion' => 'datetime',
    ];
