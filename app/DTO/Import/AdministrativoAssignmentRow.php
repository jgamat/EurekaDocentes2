...
class AdministrativoAssignmentRow
{
    ...
    public ?float $monto = null; // monto opcional para inicializar cargo en caso esté en 0 o null

    public ?string $montoEstado = null; // estado visual de aplicación del monto en la importación
