...
class AsignarCargosALocalDocentes extends Page implements HasForms, HasTable
{
    ...
    protected string $view = 'filament.pages.asignar-cargos-a-local-docentes';
            ...
            ->schema([
                ...
                Select::make('proceso_id')
                    ...
                    ->afterStateUpdated(function ($state) {
                        $this->filters['proceso_id'] = (int) $state;
                ...
                Select::make('proceso_fecha_id')
                    ...
                    ->reactive()
                    ->afterStateUpdated(function ($state) {
                        $this->filters['proceso_fecha_id'] = (int) $state;
                        $this->filters['local_id'] = null;
                        $this->mostrarTabla = false;
                        $this->form->fill($this->filters);
                    })
                ...
                Select::make('local_id')
                    ...
                    ->options(function () {
                        ...
                        return Locales::where('profec_iCodigo', $fecha)
                            ...
                            ->get()
                            ->sortBy(function ($l) {
                                return $l->localesMaestro->locma_vcNombre ?? '';
                            })
                    ...
                    ->reactive()
                    ->afterStateUpdated(function ($state) {
                        $this->filters['local_id'] = (int) $state;
                        $this->mostrarTabla = false;
