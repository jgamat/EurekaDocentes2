...
class ConsultarCargos extends Page implements HasForms, HasTable
{
    ...
    protected string $view = 'filament.pages.consultar-cargos';
    ...
    protected function exportExcel()
    {
        ...
        return Excel::download(new class($rows, $title) implements FromCollection, ShouldAutoSize, WithEvents, WithHeadings, WithStyles
        {
