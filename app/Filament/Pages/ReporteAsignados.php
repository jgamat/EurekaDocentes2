...
class ReporteAsignados extends Page implements HasForms, HasTable
{
    use HasPageShield;
    ...
    protected string $view = 'filament.pages.reporte-asignados';
    ...
    protected function getCargosOptions(): array
    {
        ...
        $items = ExperienciaAdmision::where('profec_iCodigo', $fecha)
            ->with('maestro')
            ->get();
