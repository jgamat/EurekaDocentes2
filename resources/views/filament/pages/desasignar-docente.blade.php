    ...
    @if($this->asignacionActual)
        <div class="mt-6 p-4 border rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
            ...
            <ul>
                ...
                <li><b>Local:</b> {{ optional($this->asignacionActual->local?->localesMaestro)->locma_vcNombre ?? '-' }}
                </li>
                <li><b>Cargo:</b>
                    {{ optional($this->asignacionActual->experienciaAdmision?->maestro)->expadmma_vcNombre ?? '-' }}</li>
