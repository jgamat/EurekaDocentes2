@php /** @var \App\Filament\Pages\ImportarAsignacionAdministrativos $this */ @endphp
<x-filament::page>
	<div class="space-y-6">
		...
		@if(!empty($preview))
			...
			@endphp
			<div x-data="importAsignacionAdministrativos(@js($preview))" class="space-y-4">
		...
		<script>
			function importAsignacionAdministrativos(rows){
				return {
					q:'',
					onlyErrors:false,
					onlyWarnings:false,
