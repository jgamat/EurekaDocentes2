@php /** @var \App\Filament\Pages\ImportarAsignacionDocentes $this */ @endphp
<x-filament::page>
	<div class="space-y-6">
        ...
        @if(!empty($preview))
            ...
            @endphp
                        <div x-data="importAsignacionDocentes(@js($preview))" class="space-y-4">
        ...
        <script>
            function importAsignacionDocentes(rows){
                return {
                    q:'',
                    onlyErrors:false,
                    onlyWarnings:false,
