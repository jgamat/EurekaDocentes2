...
/** @var \Illuminate\Support\Collection|\App\Models\ProcesoDocente[] $asignaciones */
@endphp
<div class="space-y-3">
        ...
        <div class="overflow-x-auto max-w-full px-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
            <table class="min-w-[1100px] text-xs">
                ...
                @forelse($asignaciones as $asig)
                    ...
                    @endphp
                    <tr class="transition-colors text-gray-700 dark:text-gray-200 hover:bg-gray-100/60 hover:backdrop-brightness-105 dark:hover:bg-gray-700/60">
                        <td class="px-3 py-2">
